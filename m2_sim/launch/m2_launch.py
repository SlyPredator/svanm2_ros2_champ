...
def generate_launch_description():
    ...
    pkg_m2_description_share = get_package_share_directory("m2_description")
    pkg_m2_description_parent = os.path.dirname(pkg_m2_description_share)
    ...
    declare_robot_name = DeclareLaunchArgument(
        "robot_name", default_value="m2", description="Robot name"
    )
    ...
    # M2 static frame connection (map -> odom)
